# Ethereum–Zeko explorer design context
...
The explorer extends the bridge family into a denser data product: atmospheric motion is retained at low contrast, while tables and protocol detail use flatter white surfaces, compact type and explicit status hierarchy. Desktop emphasizes scanning; mobile converts tables into stacked rows without removing identifiers or lifecycle state.
