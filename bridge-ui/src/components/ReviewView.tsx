  ...
  return (
    <section className="review-view" data-screen-label="Review transfer">
      ...
      <div className="review-route">
        <div className="review-network"><NetworkIcon network={deposit ? "ethereum" : "zeko"} /><strong>{deposit ? "Ethereum Sepolia" : "Zeko Testnet"}</strong><span>{deposit ? "Settlement & custody" : "Execution network"}</span></div>
        <span className="review-arrow">→</span>
        <div className="review-network"><NetworkIcon network={deposit ? "zeko" : "ethereum"} /><strong>{deposit ? "Zeko Testnet" : "Ethereum Sepolia"}</strong><span>{deposit ? "Execution network" : "Settlement & custody"}</span></div>
      </div>
      <div className="summary-list">
        ...
        <div className="summary-row"><span>Signing wallet</span><strong>{deposit ? "Ethereum · Sepolia" : `Auro · ${config.minaSigningNetworkId} salt`}</strong></div>
      </div>
