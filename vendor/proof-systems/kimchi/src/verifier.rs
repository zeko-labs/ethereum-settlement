...
/// Verify a batch of zk-proofs using caller-provided verifier randomness for
/// the aggregated opening proof check.
///
/// This is the same verifier as [`batch_verify`], but lets zkVM guests derive a
/// deterministic Fiat-Shamir RNG from the proof batch instead of depending on
/// host entropy.
///
/// # Errors
///
