...
const changeFilters = createAction(
  type('Change Filters'),
  props<{ filters: MempoolFilters }>(),
);
const setActiveTx = createAction(
  type('Set Active Tx'),
  props<{ tx: MempoolTransaction }>(),
);
