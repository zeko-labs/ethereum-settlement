...
export type SnarksActions = SnarksWorkPoolActions & ScanStateActions;
export type SnarksAction = SnarksWorkPoolAction & ScanStateAction;

export const snarksReducer: ActionReducer<SnarksState, SnarksActions> =
  combineReducers<SnarksState, SnarksActions>({
