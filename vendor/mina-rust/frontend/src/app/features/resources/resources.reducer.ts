...
export type ResourcesActions = MemoryResourcesActions;
export type ResourcesAction = MemoryResourcesAction;

export const resourcesReducer: ActionReducer<ResourcesState, ResourcesActions> =
  combineReducers<ResourcesState, ResourcesActions>({
