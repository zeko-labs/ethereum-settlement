...
export type NodesActions = NodesOverviewActions &
  NodesBootstrapActions &
  NodesLiveActions;
export type NodesAction = NodesOverviewAction &
  NodesBootstrapAction &
  NodesLiveAction;

export const nodesReducer: ActionReducer<NodesState, NodesActions> =
  combineReducers<NodesState, NodesActions>({
