...
export class NodesOverviewSidePanelComponent
  ...
  implements OnInit
{
  ...
  closeSidePanel(): void {
    ...
    this.router.navigate([Routes.NODES, Routes.OVERVIEW], {
  ...
  private updateTimeInView(): void {
    ...
    this.secondsPassed++;
    this.bestTipRef.nativeElement.innerText =
      NodesOverviewSidePanelComponent.getFormattedTimeToDisplay(next);
  }
